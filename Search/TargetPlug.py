...
class funAnalyzer(object):
    ...
    attrListName = ['Func_PathList', 'Func_InDegreeList', 'Func_OutDegreeList', 'Func_AllDegreeList','Func_StrList' ]
    attrValueName =['Func_AvePath', 'Func_AveInDegree', 'Func_AveOutDegree', 'Func_AveAllDegree', 'Func_MaxInDegree', \
                    ...
                    'Func_AllEtp', 'Func_Entropy', 'Func_CfgEntropy', 'Func_E', 'Func_Cc', 'Func_Jmpp', \
    ...
    def __init__(self, fun):
        ...
        for i in funAnalyzer.attrValueName + funAnalyzer.attrValueNameJmp:
            self.attr[i] = 0.0
        for i in funAnalyzer.attrListName:
            self.attr[i] = []
    ...
    def alzInst(self):
        ...
        per = 0.0
        for key in funAnalyzer.attrValueNameJmp:
            if self.attr[key]:
    ...
    def secAnalyze(self):
        ...
        for i in funAnalyzer.attrValueNameJmp:
